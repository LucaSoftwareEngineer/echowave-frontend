...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 z-50 w-full border-b border-gray-200 bg-[#06bd8f]">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              <button
                ...
                className="inline-flex cursor-pointer items-center rounded-lg p-2 text-sm text-white hover:bg-[#06bd8f] focus:ring-2 focus:ring-gray-200 focus:outline-none sm:hidden"
              >
      ...
      <Sidebar sidebarClasse={sidebarMobile} />
      <ToastContainer />
    </>
  );
};
